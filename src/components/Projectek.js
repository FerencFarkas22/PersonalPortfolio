        ...
        <div className="projectContainer">
            ...
            <div className="box">
                ...
                <div className="project-description">
                    ...
                    <div className="buttons">
                        <a href="https://github.com/FerencFarkas22/react-pizza/tree/30cbd4158a4662b1093304a9da8df7fcde5d0b55"><button>GitHub <GitHub /></button></a>
                       <a href="https://ferencfarkas22.github.io/react-pizza/#/"><button>Weboldal megnyitása</button></a> 
                    </div>
                </div>
            </div>
            <div className="box">
                <div className="project-description">
                    ...
                    <div className="buttons">
                        <a target={'_blank'} href="https://github.com/FerencFarkas22/kockajatek"><button>GitHub <GitHub /></button></a>
                        <a target={'_blank'} href="https://ferencfarkas22.github.io/kockajatek/"><button>Weboldal megnyitása</button></a>
                    </div>
                </div>
            ...
            <div className="box">
                ...
                <div className="project-description">
                    ...
                    <div className="buttons">
                        <a target={'_blank'} href="https://github.com/FerencFarkas22/Harry-Potter-searcher"><button>GitHub <GitHub /></button></a>
                        <a target={'_blank'} href="https://ferencfarkas22.github.io/Harry-Potter-searcher/"><button>Weboldal megnyitása</button></a>
                    </div>
                </div>
            </div>
        </div>
